...
function parseSchema(obj) {
  ...
  if (obj.properties && typeof obj.properties === "object") {
    ...
    for (const [k, v] of Object.entries(obj.properties)) {
      schema2.properties[k] = parseSchema(v);
    }
  }
  ...
  if (obj.discriminator) {
    ...
    if (obj.discriminator.mapping && typeof obj.discriminator.mapping === "object") {
      ...
      for (const [k, v] of Object.entries(obj.discriminator.mapping)) {
        schema2.discriminator.mapping[k] = String(v);
      }
    }
  }
  if (obj.xml) {
...
function generateAOTHtml(specContent, sdkExamples = [], theme2 = "light") {
...
try {
  const specContent = (0, import_fs.readFileSync)((0, import_path.resolve)(process.cwd(), inputSpec), "utf-8");
  const html = generateAOTHtml(specContent, [], theme);
  const outPath = (0, import_path.resolve)(process.cwd(), outputDir);
  if (!(0, import_fs.existsSync)(outPath)) {
    (0, import_fs.mkdirSync)(outPath, { recursive: true });
  }
  (0, import_fs.writeFileSync)((0, import_path.resolve)(outPath, "index.html"), html);
  console.log("Successfully generated API documentation at " + (0, import_path.resolve)(outPath, "index.html"));
} catch (err) {

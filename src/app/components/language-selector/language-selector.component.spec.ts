...
describe('LanguageSelectorComponent', () => {
  ...
  beforeEach(async () => {
    mockLanguageService = {
      languages: signal<LanguageConfig[]>([
        { id: 'typescript', name: 'TypeScript', repo: 'cdd-ts', availableInWasm: true, selectedByDefault: true },
        { id: 'java', name: 'Java', repo: 'cdd-java', availableInWasm: false, selectedByDefault: false },
        { id: 'python', name: 'Python', repo: 'cdd-python', availableInWasm: true, selectedByDefault: false }
      ])
    };
    ...
    await TestBed.configureTestingModule({
      imports: [LanguageSelectorComponent, TestHostComponent, MatSelectModule, NoopAnimationsModule],
      providers: [
  ...
  it('should create', async () => {
    ...
    component = hostFixture.debugElement.query(By.directive(LanguageSelectorComponent)).componentInstance;
  ...
  it('should compute processed languages based on online state', async () => {
    ...
    expect(langs.find((l: import("../../models/types").LanguageConfig) => l.id === 'java')?.isDisabled).toBe(false);
    ...
    expect(langs.find((l: import("../../models/types").LanguageConfig) => l.id === 'typescript')?.isDisabled).toBe(false); // has WASM
    expect(langs.find((l: import("../../models/types").LanguageConfig) => l.id === 'java')?.isDisabled).toBe(true);  // no WASM
  });
